const resumosData = [
  {
    ...
    theses: [{"text": "Em ação de arbitramento de honorários advocatícios, caso a perícia utilize como base de cálculo o valor da causa na data de distribuição da ação originária, a correção monetária deve incidir excepcionalmente a partir dessa data-base pericial, e não do momento do arbitramento, para garantir a efetiva recomposição da desvalorização da moeda.", "processTitle": "2. REsp 2.147.280/SP - Marco inicial de correção monetária em arbitramento de honorários (Início: [00:56:10] / 01:02:13)", "type": "final"}, {"text": "A mera possibilidade de confusão basta para obstar o registro de marca impeditiva, não se exigindo prova de efetivo engano por parte dos consumidores, sendo irrelevantes a autorização de uso e o tempo de convivência pacífica declarados pela titular da marca registrada quando constatada a possibilidade de associação indevida.", "processTitle": "3. REsp 2.228.345 - Propriedade Industrial e Registro de Marca (Início: 01:11:51 / 01:31:44)", "type": "final"}, {"text": "Não há uso exclusivo do imóvel quando este também serve de residência para o filho comum, credor de alimentos, afastando a pretensão de recebimento de aluguéis pelo companheiro ou cônjuge privado do uso.", "processTitle": "4. AgInt no REsp 305... [Número incompleto]/[UF não identificada] - Arbitramento de Aluguéis entre Cônjuges (Início: 01:34:55)", "type": "final"}, {"text": "A impugnação suficiente dos fundamentos da decisão de admissibilidade do recurso especial, inclusive quanto à incidência da Súmula 7/STJ, afasta o óbice da Súmula 182/STJ, permitindo o conhecimento e posterior exame de mérito do agravo.", "processTitle": "5. EDcl no AREsp [Processo não identificado, N. 18 da pauta]/[UF não identificada] - Impugnação da Decisão de Admissibilidade (Início: 01:39:07)", "type": "final"}, {"text": "É cabível o deferimento de pedido de desistência de recurso especial formulado a qualquer tempo (art. 998, CPC), mesmo após iniciado o julgamento, quando ausentes a caracterização de recurso repetitivo ou a evidência manifesta de má-fé da parte para frustrar a formação de precedente.", "processTitle": "6. REsp [Processo não identificado, N. 17 da pauta]/[UF não identificada] - Pedido de Desistência Recursal (Início: 01:41:35)", "type": "final"}],
    relatores: ["Raul Araújo", "Antônio Carlos Ferreira", "Maria Isabel Gallotti", "Des. Conv. Luís Carlos Gambogi", "Marco Buzzi"],
...
### 1. AgInt no AREsp 2.875.18[?]/RJ - Cobrança de juros pelo FGC em falência superavitária (Início: 00:33:00)
...
### 3. REsp 2.228.345 - Propriedade Industrial e Registro de Marca (Início: 01:11:51 / 01:31:44)
...
### 4. AgInt no REsp 305... [Número incompleto]/[UF não identificada] - Arbitramento de Aluguéis entre Cônjuges (Início: 01:34:55)
...
### 5. EDcl no AREsp [Processo não identificado, N. 18 da pauta]/[UF não identificada] - Impugnação da Decisão de Admissibilidade (Início: 01:39:07)
- **Relator:** Min. Luís Carlos Gambogi (originário) / Acórdão por Min. Raul Araújo
- **Resultado:** Acolhidos com efeitos infringentes
- **Votação:** Maioria - Votaram pelo acolhimento os Ministros Raul Araújo e Antônio Carlos, vencidos os Ministros Gambogi (relator) e João Otávio de Noronha. O julgamento foi definido com o voto de desempate da Ministra Presidente.
...
### 6. REsp [Processo não identificado, N. 17 da pauta]/[UF não identificada] - Pedido de Desistência Recursal (Início: 01:41:35)
- **Relator:** Min. Isabel Gallotti
...
### 7. REsp 1.419.381/[UF não identificada] - Ação Civil Pública e Liquidação de Sentença (Início: 01:47:58)
- **Relator:** Min. Buzzi
- **Resultado:** Pedido de vista
...
### 8. AREsp 2.868.681/[UF não identificada] - Competência Interna (Início: 01:57:35 / 02:02:05)
...
## Estatísticas
- Total de processos julgados: 8
- Providos: 1
- Desprovidos: 3
- Parcialmente providos: 0
- Outros: 4 (2 Pedidos de vista, 1 Desistência homologada, 1 Adiado)`
  },
  {
...
- Adiados / Retirados / Cancelados: 8`
  },
  {
    ...
    relatores: ["Ricardo Villas Bôas Cueva", "Humberto Martins", "Maria Isabel Gallotti", "João Otávio de Noronha"],
...
- Outros: 3 (1 não conhecido, 2 suspensos por pedido de vista)`
  },
  {
    ...
    relatores: ["João Otávio de Noronha", "Raul Araújo", "Luis Felipe Salomão", "Marco Buzzi", "Antônio Carlos Ferreira", "Maria Isabel Gallotti", "Des. Conv. Luís Carlos Gambogi"],
...
- **Relator:** Min. João Otávio de Noronha / Min. Luís Carlos Gambogi (segmento consolidado)
- **Resultado:** Desprovido
- **Votação:** Unânime
...
- Partes de vídeo consolidadas: 2`
  },
  {
    ...
    relatores: ["João Otávio de Noronha", "Nancy Andrighi", "Raul Araújo", "Ricardo Villas Bôas Cueva", "Humberto Martins", "Maria Isabel Gallotti", "Moura Ribeiro"],
...
### 1. Rcl 48.281/DF - Questão de Ordem sobre Competência (Início: 21:01)
- **Relator:** Min. João Otávio de Noronha
- **Resultado:** Questão de ordem acolhida
- **Votação:** Unânime
- **Tese fixada:** A competência para o julgamento dos referidos embargos de divergência é da Corte Especial, impondo-se a anulação das decisões proferidas pela Segunda Seção, ante a incompetência do órgão julgador.
- **Resumo da discussão:** O Ministro Relator apresentou questão de ordem suscitando um equívoco ocorrido na distribuição do feito, uma vez que a competência originária para o seu julgamento seria da Corte Especial e não da Segunda Seção. Propôs a anulação das decisões e dos julgamentos anteriores realizados pela Segunda Seção, a fim de que seja providenciada a imediata redistribuição do processo à Corte Especial. O colegiado acolheu a questão de ordem por unanimidade.

### 2. CC 207.504/MG - Conflito de Competência sobre Reconhecimento de Uniões Estáveis Simultâneas (Início: 22:29)
- **Relator:** Min. João Otávio de Noronha
- **Resultado:** Conhecido em parte para declarar a competência do juízo suscitado (12ª Vara de Família de São Paulo/SP).
- **Votação:** Unânime
- **Tese fixada:** A competência para processar e julgar ação de reconhecimento de união estável é da Justiça Estadual (Varas de Família). A análise da relação jurídica familiar pela Justiça Federal ocorre de forma meramente incidental para amparar pedido de benefício previdenciário (pensão por morte) e não irradia efeitos de coisa julgada material perante terceiros com interesse próprio que não participaram da lide. Havendo demandas propostas em juízos estaduais distintos, define-se a competência pelo critério da prevenção, fixada no juízo onde foi ajuizada a primeira ação.
- **Resumo da discussão:** O conflito de competência foi suscitado por um espólio diante da tramitação simultânea de ações nas justiças estaduais de São Paulo e Minas Gerais, e na Justiça Federal de Minas Gerais, onde diferentes partes pleiteiam o reconhecimento de união estável em períodos coincidentes. O relator firmou que a Justiça Federal não é competente para o reconhecimento principal da união estável com efeitos de coisa julgada material contra terceiros, servindo a sentença estadual como base. Constatada a existência de múltiplas ações na Justiça Estadual, reconheceu-se a prevenção do Juízo da 12ª Vara de Família de São Paulo (primeira demanda ajuizada), determinando-se a suspensão da ação concorrente em Uberaba por prejudicialidade externa.

### 3. Recurso Especial [Não identificado]/MG - Locação por plataformas digitais (Airbnb) em condomínios residenciais (Início: 00:34:09)
- **Relator:** Min. Nancy Andrighi
- **Resultado:** Desprovido
- **Votação:** Maioria (5 a 4). Vencidos os Ministros Antônio Carlos Ferreira, Villas Bôas Cueva, Humberto Martins e Luís Carlos Gambogi.
- **Tese fixada:** A locação de unidades autônomas por curta duração via plataformas digitais possui caráter atípico e comercial, alterando a destinação do imóvel. Portanto, é proibida em condomínios com destinação estritamente residencial, salvo se houver autorização expressa na convenção condominial ou aprovação de modificação de destinação por quórum qualificado (2/3 dos condôminos), nos termos do art. 1.355 do Código Civil.
- **Resumo da discussão:** A Segunda Seção debateu intensamente a legalidade da locação de curtíssima temporada via Airbnb em condomínios residenciais. A defesa e a plataforma (assistente) sustentaram a incidência da Lei do Inquilinato, defendendo o direito de propriedade e os impactos no turismo. A relatora (acompanhada pelos Ministros João Otávio de Noronha, Raul Araújo, Isabel Gallotti e Daniela Teixeira) votou no sentido de que a alta rotatividade, a exploração econômica reiterada e os serviços periféricos desvirtuam a destinação residencial, exigindo aprovação qualificada de 2/3 dos condôminos para alterar o uso e garantir a segurança do condomínio. A divergência, encabeçada pelo Min. Antônio Carlos Ferreira, argumentou que a ausência de vedação expressa não permite restringir o direito de propriedade. Ao final, a Seção definiu tratar-se de "contrato atípico de curta estadia" e negou provimento ao recurso por estreita maioria.

### 4. REsp 1.873.187/SP e REsp 1.873.811/SP - Desconsideração da Personalidade Jurídica / Teoria Maior (Início: 02:03:12)
- **Relator:** Min. Raul Araújo
- **Resultado:** REsp 1.873.187/SP provido e REsp 1.873.811/SP desprovido
- **Votação:** Maioria (4 a 3). Vencidos os Ministros Nancy Andrighi, Daniela Teixeira e Humberto Martins.
...
- **Resumo da discussão:** O colegiado debateu a aplicação do art. 50 do Código Civil. O Relator defendeu interpretação restritiva da "teoria maior", pontuando que o encerramento irregular da empresa ou a frustração de bens, isoladamente, não bastam para atingir os sócios sem instrução probatória de fraude. A Min. Nancy Andrighi abriu divergência sugerindo que o fechamento irregular criasse presunção relativa de abuso (inversão do ônus da prova). O Min. João Otávio de Noronha interveio ressaltando que a burocracia estatal no Brasil inviabiliza a liquidação formal de empresas, de forma que a tese divergente esvaziaria o instituto da responsabilidade limitada. Prevaleceu o voto do relator no sentido de exigir prova efetiva e inequívoca do desvio de finalidade ou confusão patrimonial.

### 5. REsp 2.203.524/RJ, REsp [Não identificado]/RJ e REsp [Não identificado]/PR (Início: 02:49:55)
- **Relator:** Min. Ricardo Villas Bôas Cueva
- **Resultado:** Adiados
- **Votação:** N/A
- **Tese fixada:** N/A
- **Resumo da discussão:** O julgamento dos recursos foi suspenso e adiado para a próxima sessão devido a um pedido de vista antecipado manifestado em plenário.

### 6. CC 210.510/SP - Competência: Justiça do Trabalho x Juízo Arbitral (Início: 02:51:10)
- **Relator:** Min. Humberto Martins
- **Resultado:** Conhecido o conflito para declarar a competência da Justiça do Trabalho
- **Votação:** Maioria (desempate pelo Presidente, Min. Moura Ribeiro). Vencidos a Min. Isabel Gallotti e os Ministros João Otávio de Noronha, Antônio Carlos Ferreira, Villas Bôas Cueva e Marco Aurélio Bellizze.
- **Tese fixada:** Compete à Justiça do Trabalho processar e julgar demanda em que se discute o reconhecimento de vínculo empregatício, mesmo diante de contrato de prestação de serviços com cláusula compromissória de arbitragem.
- **Resumo da discussão:** O conflito repousou sobre definir o foro competente (Vara do Trabalho ou Juízo Arbitral) para julgar ação de trabalhador contratado como PJ que pleiteia o reconhecimento de vínculo de emprego, anulando contrato civil com convenção de arbitragem. A Min. Isabel Gallotti abriu divergência argumentando a favor da arbitragem com base no princípio "competência-competência" e nos recentes precedentes do STF que validam a terceirização e os contratos civis de serviço. O relator, Min. Humberto Martins, e o Min. Raul Araújo defenderam a competência da Justiça do Trabalho devido à vulnerabilidade e ausência de paridade das partes no momento da contratação da cláusula. Após empate entre os ministros da Seção, coube ao Presidente proferir voto de desempate, acompanhando a tese de proteção ao foro trabalhista.

### 7. EREsp 189.593/PA - Limites da matéria impugnada em apelação (Início: 03:28:58)
- **Relator:** Min. Maria Isabel Gallotti
- **Resultado:** Provido
- **Votação:** Unânime
- **Tese fixada:** Cassado o acórdão proferido pelo Tribunal de origem, determinando que o julgamento se limite a analisar a matéria expressamente impugnada em sede de apelação.
- **Resumo da discussão:** O julgamento foi retomado com a apresentação de voto-vista do Min. Humberto Martins, que acompanhou integralmente o voto proferido pela relatora em assentada anterior. O colegiado deu provimento aos embargos de divergência para cassar o acórdão estadual, reconhecendo que a Corte local desrespeitou os limites da devolutividade recursal ao julgar além da matéria efetivamente devolvida nas razões da apelação.

### 8. AgInt nos EDcl nos EAREsp [Não identificado] - Cobertura de tratamentos fora do rol da ANS (Início: 03:31:50)
- **Relator:** Min. Moura Ribeiro
- **Resultado:** Desprovido
- **Votação:** Unânime
- **Tese fixada:** É devida a cobertura de exames ou tratamentos de saúde não incluídos no rol da ANS, consoante as alterações promovidas pela Lei 14.454/2022 na Lei 9.656/1998, conforme entendimento consolidado do colegiado.
- **Resumo da discussão:** O processo abordou a recusa de plano de saúde para custeio de tratamento fora do rol da ANS, pautada na Lei 14.454/2022. O processo fora originalmente destacado pela Min. Isabel Gallotti (que divergia do entendimento, exigindo estrita comprovação de evidência científica para cobertura). Contudo, em nome do princípio da colegialidade e constatando que a matéria está pacificada com sua tese iterativamente vencida na Seção, a Ministra retirou o destaque, resultando no desprovimento unânime do agravo interno, na esteira do relator.

## Destaques da Sessão
- **Ineditismo e Impacto no Airbnb:** Decisão paradigmática resolvida por maioria apertada (5 a 4) estipulou que locações via plataformas digitais em condomínios residenciais configuram uso comercial e atípico, sendo vedadas a não ser que haja autorização expressa da convenção ou quórum de aprovação de 2/3 dos condôminos, pondo em confronto o direito de propriedade e os direitos de vizinhança.
- **Limites à Desconsideração da Personalidade Jurídica:** Fixação de tese ratificando a rigidez da "teoria maior" no âmbito civil e empresarial (placar de 4 a 3), impedindo que o encerramento irregular, por si só, gere presunção de fraude para atingimento de sócios. O debate incluiu observações do Min. João Otávio de Noronha sobre o pesado impacto da burocracia estatal brasileira.
- **Competência em "Pejotização" vs Arbitragem:** Extenso e disputado debate teórico sobre cláusulas compromissórias e o reconhecimento de vínculo empregatício de contratados PJ. O tema evidenciou franca divisão da Corte frente a recentes decisões do STF sobre terceirização lícita, exigindo o raro voto de desempate por parte do Presidente da Seção para manter o julgamento na Justiça do Trabalho.
- **Trabalhos Extra-Pauta:** Apreciação extra-pauta de Questão de Ordem interposta pelo Min. João Otávio de Noronha para anulação de atos decisórios (Rcl 48.281/DF) decorrente de erro material na distribuição regimental de competências com a Corte Especial.
- **Gestão Processual e Colegialidade:** Realização de correção de rito com devolução de palavra para leitura de voto de relator antes de voto-vista; o alerta do Presidente quanto à necessidade de otimização de pauta (com o consequente adiamento de processos em bloco); e a retirada proativa de destaque da Min. Isabel Gallotti em tema do rol da ANS por ressalva de entendimento majoritário do colegiado.
- **Considerações Formais:** Deferimento de preferência a uma advogada lactante em comemoração antecipada ao Dia das Mães, saudação a acadêmicos de Direito visitantes da Faculdade Pitágoras e votos fraternos de pronta recuperação ao Ministro Presidente no encerramento da sessão.

## Estatísticas
- Total de processos julgados: 10 processos autuados analisados (consolidados em 8 itens de julgamento, abarcando processos julgados em conjunto e adiamentos em bloco).
- Providos: 2
- Desprovidos: 3
- Parcialmente providos: 0
- Outros: 5 (1 Questão de Ordem acolhida, 2 conflitos conhecidos/conhecidos em parte, 3 recursos adiados)`
  },
  {
    id: "2026-05-05_quarta_turma",
    ...
    relatores: ["Maria Isabel Gallotti", "Antônio Carlos Ferreira", "João Otávio de Noronha", "Raul Araújo", "Des. Conv. Luís Carlos Gambogi"],
...
- **Resumo da discussão:** O Presidente da Turma declarou a renovação do julgamento de um processo em que havia ocorrido empate. Como o Ministro Buzzi, que havia pedido vista anteriormente para desempatar, encontra-se afastado, o julgamento foi formalmente renovado e a vista foi concedida ao Ministro Luís Carlos Gambogi, seu substituto na sessão.
...
- **Relator:** Min. Raul Araújo
- **Resultado:** Pedido de vista
- **Tese fixada:** [PROPOSTA] A Súmula 410 do STJ exige a prévia intimação pessoal do obrigado para a cobrança de multa cominatória, sendo insuficiente a mera comunicação por e-mail por não garantir a certeza e o exato momento da ciência do destinatário (proposta de voto do relator).
...
- **Relator:** Min. Luís Carlos Gambogi (mencionado)
- **Resultado:** Adiado
- **Votação:** Unânime
...
- Outros: 12`
  },
  {
    ...
    relatores: ["Antônio Carlos Ferreira", "Maria Isabel Gallotti", "João Otávio de Noronha", "Raul Araújo"],
...
- Adiados/Suspensos: 7`
  },
  {
    ...
    relatores: ["Ricardo Villas Bôas Cueva", "Raul Araújo", "Antônio Carlos Ferreira", "Moura Ribeiro", "João Otávio de Noronha"],
...
- Outros: 9 (suspensos por pedido de vista e retirados de pauta)`
  },
  {
    ...
    theses: [],
    relatores: ["Antônio Carlos Ferreira", "Maria Isabel Gallotti", "Raul Araújo", "João Otávio de Noronha", "Des. Conv. Luís Carlos Gambogi"],
...
### N. 1 - REsp 2.240.242/RJ - Nulidade de atos processuais (Início: 31:42)
- **Relator:** Min. Antônio Carlos Ferreira
- **Resultado:** Em julgamento (Pendente de conclusão)
- **Votação:** Relator e Min. Marco Aurélio Buzzi pelo conhecimento parcial e desprovimento; Min. Maria Isabel Gallotti pela divergência (provimento). O Min. Raul Araújo iniciou o seu voto.
- **Resumo da discussão:** O processo retornou para continuidade de julgamento. O relator havia proferido voto para conhecer em parte do recurso e negar-lhe provimento, acompanhado pelo Min. Marco Aurélio Buzzi. A Min. Maria Isabel Gallotti apresentou divergência para decretar a nulidade dos atos processuais a partir da citação e reabrir o prazo para contestação. O Presidente advertiu que, se o Min. Raul Araújo acompanhasse a divergência, haveria empate. O julgamento seguiu com o início do voto do Min. Raul Araújo.

### N. 2 - [Processo não identificado] - Validade de citação de pessoa jurídica estrangeira (Início: 00:34:22)
- **Relator:** Min. [Não identificado]
- **Resultado:** Adiado
- **Votação:** Em andamento
- **Resumo da discussão:** O debate cinge-se à validade da citação de uma sociedade empresária estrangeira (Hyundai Corporation) realizada na pessoa jurídica de uma empresa brasileira do mesmo grupo econômico (Hyundai Caoa). O ministro votante acompanhou a divergência da Min. Maria Isabel Gallotti pela decretação de nulidade dos atos a partir da citação, asseverando a necessidade de carta rogatória. Contudo, devido ao comparecimento espontâneo no recurso especial, dispensou-se nova citação, determinando-se a reabertura do prazo de contestação no primeiro grau. O julgamento foi adiado para a sessão seguinte para oportunizar sustentações orais.

### N. 3 - AgInt no AREsp 1.813.843/[UF não identificada] - Cerceamento de defesa e prova pericial em fraude bancária (Início: 00:41:27)
- **Relator:** Min. Maria Isabel Gallotti
- **Resultado:** Desprovido
- **Votação:** Maioria (vencido o Min. Marco Buzzi)
- **Resumo da discussão:** Trata-se de agravo interno do banco réu contra decisão da relatora que anulou as decisões das instâncias ordinárias por cerceamento de defesa, determinando perícia contábil. A demanda envolve uma fraude perpetrada por ex-gerente que forjava extratos para ocultar desvios. A relatora sustentou ser inaplicável a Súmula 7/STJ, argumentando que o dano material não pode ser presumido apenas com base nos extratos falsificados e que a perícia feita em liquidação baseou-se nessa premissa irreal. Foi consolidado que a perícia deve rastrear a origem e o destino dos recursos por extratos oficiais, atenuando-se a exigência ao assentar que os correntistas não precisam provar a legalidade ou origem dos recursos, apenas que realizaram os aportes reclamados. O Min. Marco Buzzi divergiu reputando suficiente a perícia em liquidação provisória, mas restou vencido.

### N. 4 - AREsp 397 (numeração incompleta)/[UF não identificada] - Homologação de acordo extrajudicial (Início: 01:40:43)
- **Relator:** Min. Antônio Carlos Ferreira
- **Resultado:** Acordo homologado
- **Votação:** Unânime
- **Resumo da discussão:** O processo retornava com voto-vista, porém as partes atravessaram petição noticiando composição amigável da lide. O relator submeteu o acordo à Turma para homologação colegiada, estipulando expressamente que, em caso de eventual inadimplência, a execução das obrigações deverá ocorrer no juízo de primeiro grau.

### N. 5 - REsp 1.474.049 (numeração provável)/PI - [Tema não identificado] (Início: 01:42:42)
- **Relator:** [Não identificado]
- **Resultado:** Adiado / Retirado de pauta provisoriamente
- **Votação:** N/A
- **Resumo da discussão:** O processo foi apregoado, contudo o Presidente identificou que o feito aguardava o voto de desempate do Min. Ricardo Villas Bôas Cueva. Diante de sua ausência, o julgamento foi adiado/cancelado nesta assentada.

### N. 6 - REsp 2.193.748/RJ - Responsabilidade civil de montadora e valoração de prova pericial (Início: 01:43:39)
- **Relator:** Min. Raul Araújo
- **Resultado:** Pedido de vista antecipado
- **Votação:** Iniciada (voto do relator pelo provimento)
- **Resumo da discussão:** O litígio trata da responsabilidade civil da montadora Honda por ausência de acionamento do airbag frontal em colisão. O relator votou por dar provimento ao recurso especial da montadora, argumentando que o acórdão estadual desconsiderou laudo pericial técnico (que atestava colisão lateral, situação em que o airbag frontal não deveria ser acionado) sem fundamentação idônea, configurando errônea valoração da prova e afronta ao CPC. Logo após a leitura da ementa, o Min. Antônio Carlos Ferreira formulou pedido de vista antecipado.

### N. 7 - REsp [Processo não identificado]/GO - Ação Rescisória / Responsabilidade Civil (Início: 02:02:48)
- **Relator:** Min. João Otávio de Noronha
- **Resultado:** Desprovido
- **Votação:** Unânime (nos termos do voto do Relator)
- **Resumo da discussão:** Recurso contra acórdão que julgou procedente ação rescisória, desconstituindo condenação civil solidária por envolvimento no furto de mais de 16 mil cabeças de gado. O recorrente alegou que a absolvição criminal posterior por falta de provas não configurava erro de fato ou prova nova. O relator votou por manter o acórdão rescindendo, fundamentando que a decisão originária incorreu em erro de fato ao presumir a participação do réu no ilícito sem que a ação penal sequer descrevesse conduta direta sua na subtração. Concluiu que a absolvição apenas corroborou a ausência de provas de concorrência. 

### N. 8 - [Processo não identificado] - [Tema não identificado] (Início: 02:33:55)
- **Relator:** [Não identificado]
- **Resultado:** Conhecido e desprovido
- **Votação:** Unânime
- **Resumo da discussão:** A gravação capta apenas os momentos finais de julgamento de um recurso especial. O relator conclui seu voto pelo conhecimento e desprovimento. Sem divergência, o resultado é proclamado de forma unânime.

### N. 9 - REsp 2.133.082/MG - Indenização securitária e aplicação do CDC (Início: 02:34:37)
- **Relator:** [Não identificado]
- **Resultado:** Julgamento suspenso por pedido de vista
- **Votação:** Iniciada (Voto do relator pelo conhecimento parcial e desprovimento)
- **Resumo da discussão:** Controvérsia sobre recusa de cobertura de sinistro de helicóptero pela seguradora (MAPFRE), sob argumento de que o piloto possuía experiência inferior ao exigido na apólice (2.000 horas). A recorrente (Brastub) defendeu a aplicação do CDC, alegando vulnerabilidade técnica e abusividade de cláusula. O relator votou por conhecer parcialmente e negar provimento, ressaltando que as instâncias ordinárias firmaram que a segurada possuía plena ciência da exigência, incidindo as Súmulas 5 e 7 do STJ. Após o voto, houve pedido de vista pelo Desembargador Convocado Luís Carlos Gambogi, porém o Presidente oportunizou a sustentação oral da recorrida para garantir o contraditório antes da suspensão do feito.

### N. 10 - EDcl no [Processo 2.611.99?]/RJ - Correção de erro material (Início: 03:09:16)
- **Relator:** Min. Raul Araújo
- **Resultado:** Pedido de vista
- **Votação:** Pendente
- **Resumo da discussão:** O processo tratava de embargos de declaração em que o relator acolhia o recurso em parte apenas para corrigir erro material no acórdão (substituindo "patente" por "marca"), confirmando que o marco inicial para o período de transição é a publicação do julgamento dos segundos embargos. O julgamento foi suspenso por pedido de vista antecipada do Min. João Otávio de Noronha.

### N. 11 - [Processo não identificado] (N. 14 da pauta) - Busca e apreensão / Alienação fiduciária (Início: 03:10:51)
- **Relator:** [Não identificado / Presidente da Turma]
- **Resultado:** Provido
- **Votação:** Unânime
- **Resumo da discussão:** Controvérsia sobre a validade da constituição em mora quando a notificação enviada ao endereço contratual é devolvida como "não procurado". O relator aplicou a diretriz do Tema 1.132 do STJ, dispensando prova de recebimento e ressaltando que incumbe ao devedor atualizar seu endereço. O recurso foi provido para determinar o prosseguimento da busca e apreensão e afastar a multa aplicada na origem aos embargos.

### N. 12 - [Processo não identificado] (N. 16 da pauta) - Busca e apreensão / Alienação fiduciária (Início: 03:15:52)
- **Relator:** [Não identificado / Presidente da Turma]
- **Resultado:** Retirado de pauta
- **Votação:** N/A
- **Resumo da discussão:** Processo que cuidava da mesma questão jurídica do item anterior. O relator percebeu uma contradição interna em seu gabinete, pois a proposta elaborada era de não conhecimento, diferindo do provimento concedido no caso anterior. Optou por retirar de pauta para unificação do entendimento interno.

### N. 13 - [Processo não identificado] (N. 15 da pauta) - Busca e apreensão / Alienação fiduciária (Início: 03:19:05)
- **Relator:** [Não identificado / Presidente da Turma]
- **Resultado:** Provido
- **Votação:** Unânime
- **Resumo da discussão:** Recurso versando sobre o mesmo tema dos itens 14 e 16 da pauta (notificação devolvida como "não procurado"). O recurso foi provido à unanimidade, espelhando a decisão tomada no item 14.

### N. 14 - [Processo não identificado] (N. 17 da pauta) - Tema não especificado (Início: 03:20:09)
- **Relator:** [Não identificado]
- **Resultado:** Adiado / Segurado
- **Votação:** N/A
- **Resumo da discussão:** O processo chegou a ser mencionado para julgamento, contudo, a pedido de um integrante da Turma (aparentemente a Min. Maria Isabel Gallotti), sua apreciação foi reservada para um momento posterior na sessão.

### N. 15 - [Processo não identificado] (N. 19 da pauta) - Plano de saúde / Cirurgia robótica (Início: 03:21:05)
- **Relator:** [Não identificado / Presidente da Turma]
- **Resultado:** Conhecido e parcialmente provido
- **Votação:** Unânime
- **Resumo da discussão:** Ação objetivando a cobertura de tratamento de câncer de próstata utilizando técnica robótica, negada pela operadora. O relator invocou precedente da Segunda Seção sobre a mitigação do rol da ANS, fixando o dever de custeio integral quando houver indicação médica da técnica para doença coberta. O recurso foi conhecido e provido em parte para garantir a cirurgia e determinar retorno à origem para análise de danos morais. O colegiado saneou a ementa durante a sessão, expurgando teses processuais do dispositivo.

### N. 16 - [Processo não identificado] (N. 26 da pauta) - Cédula de Produto Rural (CPR) / Registro (Início: 03:26:45)
- **Relator:** Min. Maria Isabel Gallotti
- **Resultado:** Pedido de vista antecipado
- **Votação:** Pendente
- **Resumo da discussão:** Debate acerca da necessidade de registro ou depósito em entidade autorizada como requisito de validade, executividade e eficácia perante terceiros da Cédula de Produto Rural (CPR). A relatora propôs o provimento para extinguir a execução ante a ausência de registro. Ocorreu intenso debate semântico sobre a diferença entre "nulidade" e "perda de eficácia" frente às inovações legislativas de 2022. Diante da carência de precedentes recentes da Turma, o Min. João Otávio de Noronha solicitou vista antecipada.

### N. 17 - AREsp 77.165/[UF] - Retirada de destaque e capitalização diária (Início: 03:36:22)
- **Relator:** Min. Raul Araújo
- **Resultado:** Parcialmente provido
- **Votação:** Unânime
- **Resumo da discussão:** O Min. João Otávio de Noronha retirou destaque que havia formulado anteriormente, justificando que a controvérsia imaginada sobre capitalização diária não era objeto do recurso. Sem pedidos de preferência, a Turma acompanhou o relator para conhecer do agravo e dar parcial provimento ao recurso especial.

### N. 18 - REsp [Final 138]/[UF] - Nulidade de julgamento em sessão virtual (Início: 03:37:52)
- **Relator:** Min. Relatora [Não identificada nominalmente]
- **Resultado:** Julgamento de sessão virtual tornado sem efeito
- **Votação:** Unânime
- **Resumo da discussão:** O processo foi chamado para deliberação de questão de ordem. A relatora propôs anular julgamento ocorrido em sessão virtual devido a uma falha procedimental do sistema, onde um pedido de retirada de pauta atrelado a um agravo acabou removendo apenas o recurso de uma das partes do ambiente virtual. O vício foi sanado e a sessão virtual do feito foi anulada.

### N. 19 - REsp [Não identificado]/SC - Uso do sistema SERPJUD (CPJUD) na busca de bens penhoráveis (Início: 03:39:13)
- **Relator:** Min. Luís Carlos Gambogi [Conforme transcrição]
- **Resultado:** Provido
- **Votação:** Unânime
- **Resumo da discussão:** A controvérsia envolvia o indeferimento pelo Tribunal de origem de consulta ao Sistema Eletrônico dos Registros Públicos (SERPJUD) para localizar bens em execução de título extrajudicial. O relator, amparado no princípio da cooperação, reputou a negativa irregular. O recurso foi provido para determinar o rejulgamento na origem sob a premissa de que o uso do sistema é plenamente legal no âmbito cível, independentemente do esgotamento prévio de diligências pelas partes.

### N. 20 - REsp 2.002.734/SP - Exigência de publicação de balanços por sociedade limitada de grande porte (Início: 03:45:31)
- **Relator:** Min. Antônio Carlos Ferreira
- **Resultado:** Desprovido
- **Votação:** Unânime
- **Resumo da discussão:** Mandado de segurança de sociedade limitada de grande porte contra a JUCESP. O litígio debatia a validade de deliberações infralegais da Junta Comercial que condicionavam o arquivamento de atos societários à publicação de balanços. O relator ratificou a decisão estadual de que o art. 3º da Lei 11.638 não determina tal obrigação, configurando excesso regulamentar e afronta ao princípio da legalidade. 

### N. 21 - AREsp 935.216/[UF] - Sub-rogação de coobrigado e sucessão no polo ativo da execução (Início: 03:49:10)
- **Relator:** Min. Raul Araújo
- **Resultado:** Provido
- **Votação:** Unânime
- **Resumo da discussão:** O processo versava sobre a sucessão processual na via executiva por empresa corré que efetuou o pagamento integral da dívida e pretendia executar o devedor principal. O relator assentou que a sub-rogação do terceiro ocorre de pleno direito, tornando desnecessária ação autônoma de regresso ou renovação da intimação para pagamento. Atendendo à sugestão do Colegiado, ressaltou-se na ementa que o pagamento na origem foi "integral". O agravo foi conhecido e o recurso provido de forma unânime.

## Destaques da Sessão
- **Abertura e informes:** A sessão foi antecedida por um extenso bloco de informes institucionais do STJ (acessibilidade, portal, campanhas) e aprovação da ata da 5ª sessão ordinária (17/03/2026).
- **Adequações procedimentais em bloco:** Observou-se celeridade na homologação de acordo extrajudicial diretamente pela Turma (AREsp 397) e agilidade na identificação de casos de adiamento (processos dependendo de voto de desempate de ministro ausente).
- **Gestão interna de pauta:** O presidente da Turma retirou de pauta processo (N. 16) de forma transparente ao constatar contradição de entendimento nas teses elaboradas pela própria equipe de gabinete frente a caso idêntico recém-julgado.
- **Debate sobre limites probatórios e Súmula 7:** 
  - Em casos de fraudes bancárias complexas, estabeleceu-se o cerceamento de defesa diante da recusa de perícia contábil em extratos oficiais, afastando-se o óbice da Súmula 7 para garantir a prova necessária à elucidação do dano material (AgInt no AREsp 1.813.843).
  - Julgamento envolvendo montadora (REsp 2.193.748/RJ) também orbitou sobre os limites do juiz para afastar laudo pericial aplicando regras de experiência, gerando pedido de vista.
- **Inversão atípica do contraditório:** Em julgamento de seguro aeronáutico (REsp 2.133.082/MG), a Presidência oportunizou a sustentação oral da parte recorrida mesmo após a prolação do voto do relator e antes do recolhimento dos autos por pedido de vista.
- **Saneamento dinâmico de Ementas:** Colegiado realizou adequações redacionais ao vivo em múltiplos processos, como no expurgo de teses processuais do dispositivo sobre cirurgia robótica e na inclusão do termo "pagamento integral" na tese de sub-rogação na via executiva.
- **Rigor semântico em Direito do Agronegócio:** O debate sobre a Cédula de Produto Rural (CPR) revelou cautela profunda do colegiado quanto aos institutos de nulidade versus eficácia perante terceiros após inovações legislativas, motivando pedido de vista antecipado por falta de precedentes recentes.
- **Diálogo aberto sobre acessibilidade e organização:** O Presidente relatou de modo transparente uma limitação auditiva temporária para alinhar o andamento dos trabalhos e fez apelo público aos gabinetes pela disponibilização precoce de votos, visando equalizar as condições da Turma e dos advogados presentes.

## Estatísticas
- Total de processos julgados: 21 (incluindo processos em andamento, adiados e retirados de pauta)
- Providos: 4
- Desprovidos: 4
- Parcialmente providos: 2
- Outros: 11 (4 pedidos de vista, 3 adiados/segurados, 1 em julgamento/andamento, 1 acordo homologado, 1 retirado de pauta, 1 anulação de sessão virtual)`
  },
  {
    id: "2026-03-17_quarta_turma",
    title: "Quarta Turma - 17/03/2026",
    date: "17/03/2026",
    orgao: "Quarta Turma",
    videoUrls: ["https://www.youtube.com/watch?v=fR4fdYa4i30"],
    theses: [],
    relatores: ["João Otávio de Noronha", "Raul Araújo", "Antônio Carlos Ferreira", "Maria Isabel Gallotti"],
...
- Outros: 8 (adiamentos e aprovações sem explicitação de dispositivo)`
  },
  {
    ...
    relatores: ["Moura Ribeiro", "Antônio Carlos Ferreira", "Ricardo Villas Bôas Cueva", "Nancy Andrighi", "João Otávio de Noronha", "Marco Buzzi", "Raul Araújo"],
...
- **Consultas/Pauta:** 1`
  },
  {
    ...
    theses: [],
    relatores: ["João Otávio de Noronha", "Raul Araújo", "Maria Isabel Gallotti"],
...
- **Relator:** Min. Raul Araújo
- **Resultado:** Pedido de vista
- **Votação:** Relator negou provimento; Min. Luís Carlos Gambogi solicitou vista
...
- **Relator:** Min. Raul Araújo
- **Resultado:** Pedido de vista
- **Votação:** Relator votou pela resolução; Min. Luís Carlos Gambogi divergiu pelo reequilíbrio; Min. João Otávio de Noronha pediu vista.
...
- Outros: 12 (Inclui Pedidos de Vista, Adiamentos, Homologações e Questões de Ordem)`
  },
  {
    ...
    relatores: ["Ricardo Villas Bôas Cueva", "Nancy Andrighi", "Raul Araújo", "João Otávio de Noronha", "Humberto Martins", "Antônio Carlos Ferreira"],
...
### 1. REsp 2.168.627/SP, REsp 2.169.656/PR e REsp 2.062.627/[UF] - Cobertura de bomba de infusão contínua de insulina por planos de saúde (Tema Repetitivo 1316)
- **Relator:** Min. Ricardo Villas Bôas Cueva
- **Resultado:** Parcialmente providos (com determinação de retorno dos autos à origem para adaptação ao julgado).
- **Votação:** Unânime (registrado o impedimento da Min. Isabel Gallotti).
- **Tese fixada:** 
  1. As inovações trazidas pela Lei 14.454/2022 aplicam-se de imediato aos contratos de plano de saúde, inclusive aos anteriores à sua vigência.
  2. O sistema de infusão contínua de insulina não se enquadra nas exceções dos incisos VI e VII do art. 10 da Lei 9.656/98 (uso domiciliar e órteses/próteses), sendo inválidas as cláusulas que excluam sua cobertura.
  3. A análise judicial da obrigatoriedade de custeio deve observar os parâmetros do STF na ADI 7.265.
  4. Consideram-se preenchidos os requisitos gerais da ADI 7.265: inexistência de negativa expressa da ANS; comprovação de eficácia e segurança; e desnecessidade de análise de ato de não incorporação.
  5. O Judiciário deve verificar no caso concreto: prescrição médica, ausência de alternativa adequada no rol da ANS e registro na Anvisa.
  6. Exige-se ainda a verificação de prévio requerimento administrativo e consulta a órgãos técnicos (NAT-JUS/peritos), devendo a ANS ser oficiada em caso de deferimento. *(Nota: Por sugestão da Min. Nancy Andrighi, adotou-se a expressão inclusiva "pessoas com diabetes" em substituição a "pessoas portadoras de diabetes").*
- **Resumo da discussão:** O julgamento fixou tese nacional obrigando as operadoras a cobrirem as bombas de insulina, desde que preenchidos rigorosos critérios técnicos. Houve tentativa de um advogado de usar a tribuna para discutir multas do seu caso concreto, sendo advertido pelo colegiado de que a Corte estava focada no precedente vinculante, embora tenha assegurado a manutenção do tratamento da paciente até nova análise da origem. 

### 2. REsp 2.171.003/RS, REsp 2.171.277/RS e REsp 2.175.268/RS - Validade de notificação prévia por meio eletrônico em cadastros de inadimplência (Art. 43, § 2º, CDC)
- **Relator:** Min. Nancy Andrighi
- **Resultado:** REsp 2.171.003/RS (Provido); REsp 2.171.277/RS (Desprovido, com majoração de honorários); REsp 2.175.268/RS (Provido).
- **Votação:** Unânime.
- **Tese fixada:** "Para os fins do artigo 43, parágrafo 2º, do CDC, é válida a comunicação ao consumidor realizada por meio eletrônico, desde que comprovados o envio da notificação e a respectiva entrega ao destinatário."
- **Resumo da discussão:** O debate opôs os defensores dos consumidores (que alertaram sobre exclusão digital e o risco de fraudes eletrônicas contra hipervulneráveis) ao pragmatismo econômico. O colegiado concluiu que a evolução tecnológica (uso massivo de WhatsApp, e-mail e SMS) permite a notificação digital, o que reduz custos operacionais e tem potencial de baratear o crédito, desde que a plataforma comprove inequivocamente a entrega da mensagem ao destinatário.

### 3. REsp 1.856.311/SP e REsp 1.845.692/SP - Resilição unilateral de plano de saúde coletivo empresarial com menos de 30 vidas (Tema Repetitivo 1.082)
- **Relator:** Min. Raul Araújo
- **Resultado:** REsp 1.856.311/SP desprovido; no REsp 1.845.692/SP, homologado o acordo e a desistência dos recursos.
- **Votação:** Maioria (A Min. Nancy Andrighi e o Min. João Otávio de Noronha ficaram parcialmente vencidos apenas quanto à redação da tese, acompanhando o caso concreto).
- **Tese fixada:** "A resilição unilateral pela operadora do contrato de plano de saúde coletivo empresarial com menos de 30 beneficiários é válida desde que apresentada motivação idônea."
- **Resumo da discussão:** O mercado tem utilizado contratos sub-30 vidas como "falsos coletivos" para promover a seleção de riscos e descartar usuários onerosos. A principal divergência ocorreu na redação da tese: a Min. Nancy Andrighi alertou que a expressão aberta "motivação idônea" traria insegurança jurídica, sugerindo a especificação de causas taxativas (como fraude ou inadimplência). O Relator defendeu a cláusula aberta para permitir que o julgador avalie a idoneidade da motivação em cada caso concreto, entendimento que prevaleceu.

### 4. EDcl no AgInt nos EREsp [Processo não identificado] - Ilegitimidade passiva e atribuição de efeitos infringentes
- **Relator:** Min. João Otávio de Noronha
- **Resultado:** Adiado (Pedido de vista regimental do Relator).
- **Resumo da discussão:** O Min. João Otávio de Noronha havia proferido voto desfavorável ao embargante. Contudo, após divergências dos Ministros Raul Araújo e Ricardo Villas Bôas Cueva, que apontaram a ilegitimidade passiva da recorrente, o Relator reconheceu seu equívoco. Afirmando "não ter vergonha de mudar de opinião para não se envergonhar de aprender", alterou seu posicionamento para alinhar-se à divergência e pediu vista regimental apenas para reestruturar a fundamentação do novo voto. 

### 5. CC 210.510/SP - Conflito de competência entre Juízo Arbitral e Justiça do Trabalho (Terceirização)
- **Relator:** Min. Humberto Martins
- **Resultado:** Julgamento suspenso (Pedido de vista antecipada da Min. Isabel Gallotti).
- **Resumo da discussão:** O relator conheceu do conflito para declarar a competência da Justiça do Trabalho para examinar a existência de relação de emprego, determinando a suspensão do procedimento arbitral (art. 313, V, do CPC). A discussão evidenciou a instabilidade jurisprudencial do STJ quanto à prevalência da convenção de arbitragem em contratos de prestação de serviços (terceirização).

### 6. EResp 1.974.375/RS - Termo inicial da prescrição em revisão de contratos sucessivos de mútuo com previdência privada
- **Relator:** Min. Nancy Andrighi
- **Resultado:** Julgamento suspenso (Pedido de vista antecipada da Min. Isabel Gallotti).
- **Resumo da discussão:** A controvérsia define o marco inicial da prescrição para revisar mútuos sucessivamente repactuados. A relatora votou no sentido de que, havendo cadeia negocial contínua ("obrigação como processo"), a prescrição só começa a correr da data do último contrato firmado, não restando consumada no caso. O Min. João Otávio de Noronha abriu divergência, argumentando que cada repactuação é um negócio singular e que a tese da relatora geraria imprescritibilidade. 

### 7. CC 215.326/AM - Conflito de competência sobre guarda de menores e mudança de domicílio
- **Relator:** Min. Humberto Martins
- **Resultado:** Julgamento suspenso (Pedido de vista do Min. João Otávio de Noronha).
- **Resumo da discussão:** Conflito altamente sensível entre varas de família de Manaus/AM e Colatina/ES. A mãe, médica, mudou-se com os filhos para Manaus alegando violência doméstica; o pai acusou alienação parental e *forum shopping*. O relator votou pelo reconhecimento da competência de Manaus (atual domicílio das crianças), fundamentando que a *perpetuatio jurisdictionis* cede ao princípio do melhor interesse da criança e do juiz imediato (ECA, art. 147, I, e Súmula 383/STJ). A Min. Nancy Andrighi antecipou voto acompanhando o relator antes do pedido de vista do Min. Noronha.

### 8. AgInt nos EAREsp 240.519/SP - Rescisão Contratual e Reintegração de Posse
- **Relator:** Min. Antônio Carlos Ferreira
- **Resultado:** Desprovido.
- **Votação:** Unânime.
- **Resumo da discussão:** O agravante alegou cerceamento de defesa e adimplemento substancial. O relator rechaçou o recurso, explicando que o acórdão embargado limitou-se ao juízo de admissibilidade (Súmulas 5 e 7 do STJ), o que atrai o óbice da Súmula 315/STJ, por falta de similitude fático-jurídica com os paradigmas apontados.

---

## Destaques da Sessão

- **Informativos e Ações Institucionais:** No início da sessão, presidida pelo Min. Moura Ribeiro, foram anunciadas iniciativas do STJ, como: reforma da biblioteca, atendimento em Libras, resumos em linguagem simples, alertas contra golpes, selo "tribunal amigo da pessoa idosa" e mapeamento de processos envolvendo equidade racial.
- **Composição e Homenagens:** O Desembargador Convocado Luís Carlos Gambogi (TJMG) foi recepcionado na vaga do Min. Marco Buzzi. Foram aprovadas moções de pesar pelo falecimento do Min. Felix Fischer (com resgates emocionados de sua trajetória) e pelo falecimento da mãe da Ministra Nancy Andrighi.
- **Racionalidade e Dinamismo Procedimental:** Houve acordos para otimizar o tempo: leitura de ementas/teses antes das sustentações orais nos repetitivos (Tema 1316) e dispensa de sustentação oral afetada por falhas técnicas, com a concordância de todos.
- **Colegialidade e Grandeza Institucional:** O reconhecimento público de erro pelo Min. João Otávio de Noronha (que alterou seu voto para seguir a divergência) foi um ponto alto, demonstrando o espírito colaborativo na construção da melhor jurisprudência.
- **Sensibilidade no Direito de Família:** O julgamento do CC 215.326/AM exigiu extrema cautela dos ministros, abordando nuances complexas de violência de gênero contra alienação parental. 
- **Presidência Dinâmica:** Devido aos horários de voos comerciais, a presidência da sessão foi alternada durante o andamento, passando do Min. Moura Ribeiro para a Min. Nancy Andrighi, e concluída sob a condução do Min. Humberto Martins.

---

## Estatísticas
- **Total de processos julgados e/ou apregoados:** 13 processos (identificados nas deliberações conjuntas e individuais).
- **Providos:** 2 
- **Desprovidos:** 3
...
- **Outros:** 5 (Sendo 4 adiados por pedidos de vista/vista regimental e 1 homologação de acordo/desistência).`
  },
  {
    ...
    relatores: ["Antônio Carlos Ferreira", "João Otávio de Noronha", "Raul Araújo"],
...
- **Estreia e Boas-Vindas:** A sessão marcou a estreia do Desembargador convocado Luís Carlos Gambogi (TJMG) na Quarta Turma, recebido com homenagens pelo perfil pacificador. Houve também a saudação de boas-vindas à Dra. Laura Noemi dos Santos (MPF) e o registro do retorno médico do Min. Raul Araújo.
...
window.resumosData = resumosData;
